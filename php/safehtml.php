<?php
/*
Plugin Name: Safe HTML Checker
Plugin URI: http://simon.incutio.com/archive/2003/02/23/safeHtmlChecker
Description: Loads the SafeHtmlChecker class made by Simon Willison.
Version: 1.1
Author: Simon Willison
Author URI: http://simon.incutio.com
*/
...
/* SafeHtmlChecker - checks HTML against a subset of
   ...
   Update 1st June 2005: added rel and hreflang attributes to allowed for a element,
      as well as xml:lang for various elements -- Ben de Groot.

*/

// Entity classes, adapted from XHTML 1.0 strict DTD
define('E_INLINE_CONTENTS', 'br b i tt img em hr font strong dfn code q samp kbd var cite abbr acronym sub sup a #PCDATA');
define('E_BLOCK_CONTENTS', 'dl h1 h2 h3 h4 h5 h6 ul ol blockquote p pre');
...
class SafeHtmlChecker {
    ...
    var $tags = array(
        ...
        'dd' => E_FLOW_CONTENTS,
        // Inline elements
        'hr' => E_INLINE_CONTENTS,
        'font' => E_INLINE_CONTENTS,
        'pre' => E_INLINE_CONTENTS,
        'br' => E_INLINE_CONTENTS,
        'em' => E_INLINE_CONTENTS,
        'b' => E_INLINE_CONTENTS,
        'i' => E_INLINE_CONTENTS,
        'img' => E_INLINE_CONTENTS,
        'tt' => E_INLINE_CONTENTS,
    ...
    var $tagattrs = array(
        ...
        'q' => 'cite xml:lang',
        'a' => 'href title rel hreflang xml:lang',
        'font' => 'color size',
        'img' => 'src',
        'hr' => 'height',
        'dfn' => 'title',
        'acronym' => 'title xml:lang',
        'abbr' => 'title xml:lang',
        'p' => 'xml:lang'
    );
    // Internal variables
    ...
    function SafeHtmlChecker() {
        ...
        xml_set_object($this->parser, $this); // removed the & from &this, January 30, 2004, Mark Wubben
